...
const Contact = () => {
    return (
        <div>
            ...
            {/* adres */}
            <div className='bg-[#004AAD] flex    px-[15%]  '>
            ...
            <div className='flex bg-[#004AAD]  justify-center items-center flex-wrap'>
             ...
             Реквизиты ООО "Фанторг"
              ...
              {/*KARTA */}
              <div>
                <h1 className='text-[50px] py-6 font-semibold flex justify-center items-center'>Как найти наш склад?</h1>
                <img src={require('./cont_img/cart.png')} alt="" />
                <img src={require('./cont_img/bazaC.png')} alt="" />
